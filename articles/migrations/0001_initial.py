# Generated by Django 3.1.6 on 2021-06-12 12:10
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Q1', models.TextField()),
                ('a1', models.CharField(default='', max_length=50)),
                ('b1', models.CharField(default='', max_length=50)),
                ('c1', models.CharField(default='', max_length=50)),
                ('d1', models.CharField(default='', max_length=50)),
                ('Q2', models.TextField()),
                ('a2', models.CharField(default='', max_length=50)),
                ('b2', models.CharField(default='', max_length=50)),
                ('c2', models.CharField(default='', max_length=50)),
                ('d2', models.CharField(default='', max_length=50)),
                ('Q3', models.TextField()),
                ('a3', models.CharField(default='', max_length=50)),
                ('b3', models.CharField(default='', max_length=50)),
                ('c3', models.CharField(default='', max_length=50)),
                ('d3', models.CharField(default='', max_length=50)),
                ('Q4', models.TextField()),
                ('a4', models.CharField(default='', max_length=50)),
                ('b4', models.CharField(default='', max_length=50)),
                ('c4', models.CharField(default='', max_length=50)),
                ('d4', models.CharField(default='', max_length=50)),
